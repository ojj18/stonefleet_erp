class ExcavatorServiceItemModel {
  final int? id;
  final int serviceId;
  final int spareId;
  ...
  const ExcavatorServiceItemModel({
    this.id,
  ...
  factory ExcavatorServiceItemModel.fromMap(Map<String, dynamic> map) {
  ...
  ExcavatorServiceItemModel copyWith({
    int? id,
    int? serviceId,
    int? spareId,
    double? quantity,
